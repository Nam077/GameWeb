...
class GamePolicy
{
    ...
    {
        return $user->checkPermissionAccess('list_game');
    }
    ...
    {
        return $user->checkPermissionAccess('create_game');
    }
    ...
    {
        return $user->checkPermissionAccess('edit_game');
    }
    ...
    {
        return $user->checkPermissionAccess('delete_game');
    }
