(function ($) {
    ...
    if($sliderActvation.length > 0){
        ...
        $sliderActvation.slick({
            prevArrow:'<button class="prev_arrow"><img width="17" height="24" src="http://localhost:8000/storage/photos/17/navigation-arrow2.webp" alt=""></button>',
            nextArrow:'<button class="next_arrow"><img width="17" height="24" src="http://localhost:8000/storage/photos/17/navigation-arrow1.webp" alt=""></button>',
        });
    };
