game_W = 0, game_H = 0;
score = 0;
let sbdfjhdsbfjhdsbfdsjhfbsdhjfbdhj = 0;
XXX = 0
YYY = 0;
xPacman = 0, yPacman = 0;
xBall = 0, yBall = 0;
...
circle_Im = new Image();
circle_Im.src = host + "/storage/files/1/pacman/circle.png";
ball_Im = new Image();
ball_Im.src = host + "/storage/files/1/pacman/ball.png";
N = 5;
die = false;
...
class game {
    ...
    update() {
        ...
        if ((AnglePacman - AngleBall + 20 * k) % 360 == 0) {
            score += 10;
            sbdfjhdsbfjhdsbfdsjhfbsdhjfbdhj = score;
        ...
        if (this.checkDie()) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (String(score) === String(socre_text) && String(sbdfjhdsbfjhdsbfdsjhfbsdhjfbdhj) === String(socre_text)) {
                        form.submit();
                    } else {
                        Swal.fire({
                            icon: 'error',
