...
let bg = new Image();
bg.src = "http://localhost:8000/storage/files/2/bg.png";
let mnIm = new Image();
mnIm.src = "http://localhost:8000/storage/files/2/money.png";
let tsIm = new Image();
tsIm.src = "http://localhost:8000/storage/files/2/ts.png";

let btIm = new Image();
btIm.src = "http://localhost:8000/storage/files/2/button.png";
N = 5;
v = [];
level = 1
