...
bg.src = host + "/storage/files/1/gold/background.png";
var hook = new Image();
hook.src = host + "/storage/files/1/gold/hook.png";
var targetIM = new Image();
targetIM.src =  host + "/storage/files/1/gold/target.png";
var dolarIM = new Image();
dolarIM.src =  host + "/storage/files/1/gold/dolar.png";
var levelIM = new Image();
levelIM.src =  host + "/storage/files/1/gold/level.png";
var clockIM = new Image();
clockIM.src =  host + "/storage/files/1/gold/clock.png";
            ...
            if (this.score >= tager || this.checkWin())
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        document.getElementById("score").value = score_game;
                        var socre_text = document.getElementById("score").value;
                        if (String(score_game) === String(socre_text) ) {
                            form.submit();
                        } else {
                            Swal.fire({
                                icon: 'error',
