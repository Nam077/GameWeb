                            ...
                            <div class="footer_winners_gallery">
                                <div class="footer_winners_list d-flex">
                                    <div class="footer_winners_thumb">
                                        <a href="game-details.html"><img aria-label="game-team" width="75" height="75" src="{{ asset('sites/assets/img/others/winners1.webp') }}" alt=""></a>
                                    </div>
                                    <div class="footer_winners_thumb">
                                        <a href="game-details.html"><img aria-label="game-team" width="75" height="75" src="{{ asset('sites/assets/img/others/winners2.webp') }}" alt=""></a>
                                    </div>
                                    <div class="footer_winners_thumb">
                                        <a href="game-details.html"><img aria-label="game-team" width="75" height="75" src="{{ asset('sites/assets/img/others/winners3.webp') }}" alt=""></a>
                                    </div>
                                </div>
                                <div class="footer_winners_list d-flex">
                                    <div class="footer_winners_thumb">
                                        <a href="game-details.html"><img aria-label="game-team" width="75" height="75" src="{{ asset('sites/assets/img/others/winners4.webp') }}" alt=""></a>
                                    </div>
                                    <div class="footer_winners_thumb">
                                        <a href="game-details.html"><img aria-label="game-team" width="75" height="75" src="{{ asset('sites/assets/img/others/winners5.webp') }}" alt=""></a>
                                    </div>
                                    <div class="footer_winners_thumb">
                                        <a href="game-details.html"><img aria-label="game-team" width="75" height="75" src="{{ asset('sites/assets/img/others/winners6.webp') }}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="footer_bottom_inner d-flex justify-content-between">
                        ...
                        <div class="scroll__top_icon">
                            <a id="scroll-top" href="#"><img aria-label="scroll-top" width="46" height="40" src="{{ asset('sites/assets/img/icon/scroll-top.webp') }}" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
