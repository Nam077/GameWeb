                    ...
                    @foreach($gameScore as $item)
                        <div class="col-lg-4 col-md-6 col-12 mb-50">
                            ...
                            <div class="player_list_single_item wow fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1.1s">
                                <div class="top">
                                    <a class="image" href=""><img src="https://c.tenor.com/7Nr6U1TKp4AAAAAd/gupta-gaming-nice.gif" alt=""></a>
                                    <div class="overlay">
                                ...
                                <div class="content">
                                    ...
                                    <div class="content-shape-img">
                                        <img width="351" height="126" src="{{asset("sites/assets/img/others/tam-text-shape.webp")}}" alt="">
                                        <img width="351" height="126" src="{{asset("sites/assets/img/others/tam-text-shape2.webp")}}" alt="">
                                    </div>
                                </div>
